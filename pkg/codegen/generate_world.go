	...
	root := generator.NewRoot().AddStatements(
		...
		generator.NewFunc(nil,
			...
			Statements(
				...
				generator.NewRawStatement("  Call: func(ctx context.Context, name string, params ...uint64) ([]uint64, error) {"),
				generator.NewRawStatement("    fn := module.ExportedFunction(name)"),
				generator.NewRawStatement("    if fn == nil {"),
				generator.NewRawStatement("      return nil, fmt.Errorf(\"function %s not found in module\", name)"),
				generator.NewRawStatement("    }"),
				generator.NewRawStatement("    return fn.Call(ctx, params...)"),
				generator.NewRawStatement("  },"),
				generator.NewRawStatement("}"),
